import{r as h,j as e,H as N,L as j,a as T}from"./app-7TQoRINg.js";import{A as R}from"./app-layout-aQVFjfPM.js";import{H as I}from"./heading-Bg-7hxYP.js";import{B as m}from"./button-B14hYptM.js";import{C as p,b as g,c as y,d as f,a as x}from"./card-HlYY-FCN.js";import{I as c}from"./input-v8Dzddeo.js";import{L as o}from"./label-CgA_it3S.js";import{S as A}from"./switch-CCntLJ-I.js";import{C as P}from"./checkbox-wEG3odM0.js";import{d as E,S as M,a as U,c as H,b as u}from"./select-BCAd9Crp.js";import{d as F}from"./index-DK5ap2Wf.js";import{P as L}from"./page-help-B13kG5V1.js";import{A as O}from"./arrow-left-Cjt_KrvO.js";/* empty css            */import"./badge-D3x2GPbI.js";import"./createLucideIcon-COcR6tBl.js";import"./minus-atjnjdmC.js";import"./app-logo-icon-D-MBezm7.js";import"./house-VYpqVtj8.js";import"./phone-Ba-bFSOe.js";import"./user-cog-BMG7RYTW.js";import"./alert-CUSiPjtj.js";import"./circle-alert-x4iPpGgH.js";import"./check-hGgFQtIN.js";import"./circle-check-wCLPZlSf.js";import"./loader-circle-BR-UEWuS.js";import"./chevron-up-yk1TmQNC.js";import"./circle-help-BvSDueQL.js";import"./external-link-wwk4CRPv.js";(function(){try{var s=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};s.SENTRY_RELEASE={id:"b85bb7b5dc83f935fd7d75fdf93418434f2e0da2"}}catch{}})();try{(function(){var s=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},r=new s.Error().stack;r&&(s._sentryDebugIds=s._sentryDebugIds||{},s._sentryDebugIds[r]="4492d313-fbec-4940-9d89-d9f70f816528",s._sentryDebugIdIdentifier="sentry-dbid-4492d313-fbec-4940-9d89-d9f70f816528")})()}catch{}const D=[{value:"call_completed",label:"Call Completed",description:"Triggered when a call ends with transcript and sentiment data"},{value:"lead_qualified",label:"Lead Qualified",description:"Triggered when AI detects a hot lead (high sentiment/score)"},{value:"contact_added",label:"Contact Added",description:"Triggered when a new contact is created or imported"},{value:"contact_updated",label:"Contact Updated",description:"Triggered when contact information is modified"},{value:"campaign_started",label:"Campaign Started",description:"Triggered when a campaign is launched"},{value:"dtmf_response",label:"DTMF Response",description:"Triggered when a contact presses a phone key"}];function ye({integration:s}){const r=!!s,[a,n]=h.useState({name:s?.name||"",webhook_url:s?.webhook_url||"",events:s?.events||[],auth_type:s?.auth_type||"none",auth_credentials:s?.auth_credentials||{},is_active:s?.is_active!==void 0?s.is_active:!0}),[l,b]=h.useState({}),[v,C]=h.useState(!1),_=async t=>{t.preventDefault(),C(!0),b({});try{const d=await(await fetch(r?`/api/v1/crm-integrations/${s.id}`:"/api/v1/crm-integrations",{method:r?"PUT":"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":document.querySelector('meta[name="csrf-token"]')?.getAttribute("content")||""},body:JSON.stringify(a)})).json();d.success?T.visit("/integrations",{onSuccess:()=>{alert(`Integration ${r?"updated":"created"} successfully!`)}}):d.errors&&b(d.errors)}catch(i){alert("Failed to save integration: "+i.message)}finally{C(!1)}},k=t=>{n(i=>({...i,events:i.events.includes(t)?i.events.filter(d=>d!==t):[...i.events,t]}))},w=[{title:"Dashboard",href:F().url},{title:"CRM Integrations",href:"/integrations"},{title:r?"Edit Integration":"Create Integration",href:""}],S=[{title:"Creating an Integration",content:`1. Name: Give your integration a descriptive name (e.g., "ERPNext Production", "Salesforce CRM")
...
Solution: Check your CRM expects JSON payload. Review webhook logs for exact payload sent.`}];return e.jsxs(R,{breadcrumbs:w,children:[e.jsx(N,{title:r?"Edit Integration":"Create Integration"}),e.jsxs("div",{className:"mx-auto max-w-3xl space-y-6",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(j,{href:"/integrations",children:e.jsx(m,{variant:"ghost",size:"icon",children:e.jsx(O,{className:"h-5 w-5"})})}),e.jsx("div",{className:"flex-1",children:e.jsx(I,{title:r?"Edit Integration":"Create CRM Integration",description:"Connect Teleman to your CRM or marketing automation tool"})}),e.jsx(L,{title:"Integration Form Help",sections:S,documentationUrl:"/docs/documentation.html#crm-integrations"})]}),e.jsxs("form",{onSubmit:_,className:"space-y-6",children:[e.jsxs(p,{children:[e.jsxs(g,{children:[e.jsx(y,{children:"Basic Information"}),e.jsx(f,{children:"Configure the basic settings for your CRM integration"})]}),e.jsxs(x,{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"name",children:"Integration Name"}),e.jsx(c,{id:"name",value:a.name,onChange:t=>n({...a,name:t.target.value}),placeholder:"e.g., HubSpot Production, Salesforce CRM",required:!0}),l.name&&e.jsx("p",{className:"text-sm text-red-600",children:l.name})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"webhook_url",children:"Webhook URL"}),e.jsx(c,{id:"webhook_url",type:"url",value:a.webhook_url,onChange:t=>n({...a,webhook_url:t.target.value}),placeholder:"https://your-crm.com/webhooks/teleman",required:!0}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"The endpoint URL where webhook data will be sent"}),l.webhook_url&&e.jsx("p",{className:"text-sm text-red-600",children:l.webhook_url})]}),e.jsxs("div",{className:"flex items-center justify-between rounded-lg border p-4",children:[e.jsxs("div",{className:"space-y-0.5",children:[e.jsx(o,{htmlFor:"is_active",children:"Active Status"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Enable or disable this integration"})]}),e.jsx(A,{id:"is_active",checked:a.is_active,onCheckedChange:t=>n({...a,is_active:t})})]})]})]}),e.jsxs(p,{children:[e.jsxs(g,{children:[e.jsx(y,{children:"Events to Forward"}),e.jsx(f,{children:"Select which events should trigger webhooks to your CRM"})]}),e.jsxs(x,{className:"space-y-3",children:[D.map(t=>e.jsxs("div",{className:"flex items-start space-x-3 rounded-lg border p-4",children:[e.jsx(P,{id:t.value,checked:a.events.includes(t.value),onCheckedChange:()=>k(t.value)}),e.jsxs("div",{className:"flex-1 space-y-1",children:[e.jsx("label",{htmlFor:t.value,className:"cursor-pointer text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70",children:t.label}),e.jsx("p",{className:"text-sm text-muted-foreground",children:t.description})]})]},t.value)),l.events&&e.jsx("p",{className:"text-sm text-red-600",children:l.events})]})]}),e.jsxs(p,{children:[e.jsxs(g,{children:[e.jsx(y,{children:"Authentication"}),e.jsx(f,{children:"Configure how Teleman authenticates with your webhook endpoint"})]}),e.jsxs(x,{className:"space-y-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"auth_type",children:"Authentication Type"}),e.jsxs(E,{value:a.auth_type,onValueChange:t=>n({...a,auth_type:t,auth_credentials:{}}),children:[e.jsx(M,{id:"auth_type",children:e.jsx(U,{})}),e.jsxs(H,{children:[e.jsx(u,{value:"none",children:"None (No Authentication)"}),e.jsx(u,{value:"bearer",children:"Bearer Token"}),e.jsx(u,{value:"api_key",children:"API Key (Custom Header)"}),e.jsx(u,{value:"hmac",children:"HMAC Signature"})]})]})]}),a.auth_type==="bearer"&&e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"bearer_token",children:"Bearer Token"}),e.jsx(c,{id:"bearer_token",type:"password",value:a.auth_credentials?.token||"",onChange:t=>n({...a,auth_credentials:{token:t.target.value}}),placeholder:"your-bearer-token"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Sent as: Authorization: Bearer [token]"})]}),a.auth_type==="api_key"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"api_key_header",children:"Header Name"}),e.jsx(c,{id:"api_key_header",value:a.auth_credentials?.key||"",onChange:t=>n({...a,auth_credentials:{...a.auth_credentials,key:t.target.value}}),placeholder:"X-API-Key"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"api_key_value",children:"API Key Value"}),e.jsx(c,{id:"api_key_value",type:"password",value:a.auth_credentials?.value||"",onChange:t=>n({...a,auth_credentials:{...a.auth_credentials,value:t.target.value}}),placeholder:"your-api-key"})]})]}),a.auth_type==="hmac"&&e.jsxs("div",{className:"space-y-2",children:[e.jsx(o,{htmlFor:"hmac_secret",children:"HMAC Secret"}),e.jsx(c,{id:"hmac_secret",type:"password",value:a.auth_credentials?.secret||"",onChange:t=>n({...a,auth_credentials:{secret:t.target.value}}),placeholder:"your-hmac-secret"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Signature sent in X-Teleman-Signature header (HMAC-SHA256)"})]})]})]}),e.jsxs("div",{className:"flex justify-end gap-3",children:[e.jsx(j,{href:"/integrations",children:e.jsx(m,{type:"button",variant:"outline",children:"Cancel"})}),e.jsx(m,{type:"submit",disabled:v||a.events.length===0,children:v?"Saving...":r?"Update Integration":"Create Integration"})]})]})]})]})}export{ye as default};
//# sourceMappingURL=form-CITt9O_b.js.map
